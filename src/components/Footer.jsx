...
function Footer({ on_open_settings, on_open_note_capture, on_open_note_library, show_memory }) {
  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-right">
        ...
        <button
          className="footer-button"
          onClick={on_open_note_capture}
          aria-label={t('note_capture_entry')}
          title={t('note_capture_entry')}
        >
          <QuickNoteIcon />
        </button>
        <button
          className="footer-button"
          onClick={on_open_note_library}
          aria-label={t('note_library_entry')}
          title={t('note_library_entry')}
        >
          <NoteIcon />
        </button>
        <button
