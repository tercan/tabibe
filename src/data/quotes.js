...
const QUOTES = {
  en: [
    { text: 'One who does not crack the walnut shell to reach its core thinks the whole walnut is just shell.', author: 'Al-Ghazali' },
    { text: 'The greatest proof of foolishness is insisting on one\'s own rightness.', author: 'Ibn Sina' },
    { text: 'I would be a servant for forty years to the one who teaches me a single letter.', author: 'Ali ibn Abi Talib' },
    { text: 'Just as water resembles water, the past resembles the future.', author: 'Ibn Khaldun' },
    { text: 'Ignorance breeds fear, fear breeds hatred, hatred breeds violence.', author: 'Ibn Rushd' },
    ...
    { text: 'Truth cannot be found by seeking, yet only seekers find it.', author: 'Bayazid Bastami' },
    ...
    { text: 'Philosophy is to know the reality of things to the extent of human capacity.', author: 'Al-Kindi' },
    ...
    { text: 'Knowledge acquired without purifying the heart is nothing but a burden.', author: 'Imam al-Ghazali' },
    ...
    { text: 'Even when I know I am right, I consider the possibility that I might be wrong.', author: 'Imam al-Shafi\'i' },
    { text: 'Knowledge becomes beneficial when united with wisdom.', author: 'Shah Waliullah Dehlawi' },
    ...
    { text: 'The most accepted deed is the one done consistently, even if small.', author: 'Imam al-Nawawi' },
    { text: 'Even if you are hurt, do not hurt others.', author: 'Haji Bektash Veli' },
  ...
  tr: [
    { text: 'Ceviz kabuğunu kırıp özüne inmeyen, cevizin hepsini kabuk zanneder.', author: 'Gazzali' },
    { text: 'Aptallığın en büyük kanıtı, kendi haklılığında ısrar etmektir.', author: 'İbn-i Sina' },
    ...
    { text: 'Felsefe, insanın gücü yettiği ölçüde eşyanın hakikatini bilmesidir.', author: 'Kindi' },
